      ...
      <div className="max-w-3xl mx-auto bg-white shadow-md p-6 rounded-md">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            P33R.com (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is
            committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, disclose, and safeguard your information when
            you use our website, mobile application, or other online services
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ml-8 mt-2 text-gray-700">
            <li>
              ...
              payment information, that you voluntarily provide to us when you
              register for an account, make a purchase, or communicate with us.
            </li>
            <li>
              <strong>Usage Data:</strong> IInformation about how you interact
              with the Platform, including your IP address, browser type,
              operating system, referral URLs, and the pages you visit.
            </li>
            <li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ml-8 mt-2 text-gray-700">
            <li>
              <strong>To Provide Services:</strong> To facilitate account
              creation, process transactions, and provide the services you
              request.
            </li>
            <li>
              <strong>To Improve Our Platform:</strong> To analyze usage
              patterns, enhance user experience, and develop new features.
            </li>
            <li>
            ...
            <li>
              <strong>To Protect Our Platform:</strong> To detect, prevent, and
              respond to fraud, abuse, security risks, and technical issues.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ml-8 mt-2 text-gray-700">
            <li>
              ...
              information with third-party vendors who perform services on our
            ...
            <li>
              ...
              our rights, safety, or the integrity of the Platform.
            </li>
            <li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ml-8 text-gray-700">
            <li>
              ...
              access and correct the personal data we hold about you. You can
            ...
            <li>
              ...
              cookies by default. You can adjust your browser settings to refuse
              cookies, but this may affect your ability to use some features of
              the Platform.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            under 18. If we learn that we have collected such information, we
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            and processed in the United States or other countries. By using the
            Platform, you consent to these transfers.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            Platform. Your continued use of the Platform after any changes to
