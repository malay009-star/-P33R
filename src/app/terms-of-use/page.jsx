function PrivacyPolicy() {
  return (
    <>
      <div className="flex flex-col gap-6 justify-start items-start px-4 sm:px-6 md:px-24 py-3 bg-slate-100">
        <p className="text-[#1F1C1E] font-bold leading-normal text-4xl">
          Terms of use
        </p>
        <p className="text-[#1F1C1E] leading-normal">Welcome to PEER!</p>
        <p className="text-[#1F1C1E] leading-normal">
          These terms and conditions outline the rules and regulations for the
          use of PEER&apos;s Website, located at www.peer.com.
        </p>
        <p className="text-[#1F1C1E] leading-normal">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use PEER if you do not agree to take
        ...
        <p className="text-[#1F1C1E] font-bold leading-normal text-2xl">
          Cookies
        </p>
        <p className="text-[#1F1C1E] leading-normal">
          We employ the use of cookies. By accessing PEER, you agreed to use
          cookies in agreement with the PEER&apos;s Privacy Policy.
        </p>
        <p className="text-[#1F1C1E] leading-normal">
        ...
        <p className="text-[#1F1C1E] leading-normal">
          Unless otherwise stated, PEER and/or its licensors own the
          intellectual property rights for all material on PEER. All
          intellectual property rights are reserved. You may access this from
          PEER for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>
        <p className="text-[#1F1C1E] leading-normal">You must not:</p>
        <ul className="flex flex-col gap-3 ml-10 list-disc">
          <li className="text-[#1F1C1E]">Republish material from PEER</li>
          <li>Sell, rent or sub-license material from PEER</li>
          <li>Reproduce, duplicate or copy material from PEER</li>
          <li>Redistribute content from PEER</li>
        </ul>
        <p className="text-[#1F1C1E] leading-normal">
        ...
        <p className="text-[#1F1C1E] leading-normal">
          ...
          PEER does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of PEER,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, PEER shall not be liable for
        ...
        <p className="text-[#1F1C1E] leading-normal">
          PEER reserves the right to monitor all Comments and to remove any
        ...
        <p className="text-[#1F1C1E] leading-normal">
          You hereby grant PEER a non-exclusive license to use, reproduce, edit
        ...
        <p className="text-[#1F1C1E] leading-normal">
          ...
          the hyperlink compensates the absence of PEER; and (d) the link is in
        ...
        <p className="text-[#1F1C1E] leading-normal">
          ...
          sending an e-mail to PEER. Please include your name, your organization
        ...
        <p className="text-[#1F1C1E] leading-normal">
          No use of PEER&apos;s logo or other artwork will be allowed for
        ...
        <ul className="flex flex-col gap-3 justify-start items-start list-disc ml-10">
          <li>
        ...
        <p className="text-[#1F1C1E] leading-normal pt-4 border-t border-[#EEEEEE] w-full">
